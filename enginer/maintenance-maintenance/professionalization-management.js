...
function initTable(id){
	 $('#table-professionalization').bootstrapTable('destroy'); 
	 
	 $('#table-professionalization').bootstrapTable({
		 ...
		 columns: [
		 	...
		 	},
		 	{
		 		...
		 		formatter:function(value, row, index){
		 			if (value == null || value == '') {
		 				...
		 				var signeddate=new Date(value).Format("yyyy-MM-dd hh:mm:ss");
		 				return signeddate;
		 			}
		 	...
		 	{
		 		field: 'propertyUnitPersonMobile',
		 		align: 'center',
		 		valign: 'middle',
		 		title: '物业联系人手机号码',
		 		width:"3%",
...
function GetData(params,id){
	$.ajax({
		...
		url: apiUrl + "/ProjectRepair/GetProRepairPropertyManages",
		type: "GET",
		dataType: "json",
		data:{
